...
from opendit.models.opensora_plan import LatteT2V_skip_s_t, VideoGenPipeline_skip_s_t, ae_stride_config, getae_wrapper
...
def main(args):
    ...
    videogen_pipeline = VideoGenPipeline_skip_s_t(
