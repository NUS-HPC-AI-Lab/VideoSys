...
CUDA_VISIBLE_DEVICES=2 torchrun --standalone --nproc_per_node=1 scripts/latte/sample_latte_skip_s_t.py --config configs/latte/sample_skip_s_t.yaml > sample_skip_s_t.txt 2>&1 &
