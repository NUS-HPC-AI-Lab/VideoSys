...
#     --alloc-memory-fraction 0.8 --preprocessed-data \
#     --sp-size 1 \
#     --profile --epochs 0 --outputs baseline
...
mpirun --hostfile $HOSTFILE --np $WORLD_SIZE -N $GPUS_PER_NODE --oversubscribe \
    ...
    --sp-size 1 \
    --profile --epochs 2 --outputs baseline \
    --profile-path archive/new_api/profile/baseline/000-OpenSora/profile.json
