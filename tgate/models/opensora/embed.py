...
from tgate.modules.embed import get_1d_sincos_pos_embed_from_grid, get_2d_sincos_pos_embed_from_grid
...
class T5Encoder:
    ...
    def shardformer_t5(self):
        ...
        from tgate.core.shardformer.t5.policy import T5EncoderPolicy
        from tgate.utils.utils import requires_grad
