...
class BasicTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        self.mlp_outputs.append((self.block_idx, ff_output.cpu().clone().detach()))
...
class LatteT2V_mse(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        if not return_dict:
            return (output, spatial_mlp_outputs, temporal_mlp_outputs)
