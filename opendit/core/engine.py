...
class VideoSysEngine:
    ...
    def _create_pipeline(self, pipeline_cls, rank=0, local_rank=0, distributed_init_method=None):
        opendit.initialize(rank=rank, world_size=self.config.world_size, init_method=distributed_init_method, seed=42)
    ...
    def generate(self, *args, **kwargs):
        ...
        # return self._driver_execute_model(*args, **kwargs)
