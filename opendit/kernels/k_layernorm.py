...
# fmt: off
@triton.jit
def layer_norm_fw(X, Y, W, B, M, V, SCALE, SHIFT, seq_stride, stride, N, eps, affine: tl.constexpr, BLOCK_SIZE_N: tl.constexpr):
    # fmt: on
    """
...
def layer_norm_bwd_dx_fused(
    DX, DY, DW, DB, D_SCALE, SCALE,
    X, W, M, V,
    Lock, stride, seq_stride, N,
    # META-parameters
    affine: tl.constexpr,
