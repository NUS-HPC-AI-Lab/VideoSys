...
from opendit.core.comm import all_reduce, all_to_all_with_pad, gather_sequence, halo_exchange, split_sequence
...
def dynamic_switch(x, to_spatial_shard: bool):
    if to_spatial_shard:
        scatter_dim, gather_dim = 3, 0
    else:
        scatter_dim, gather_dim = 0, 3
